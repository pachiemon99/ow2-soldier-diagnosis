...
const csvPath = path.join(root, 'owcoach_feature_entitlement_db_v50_13.csv');
const contractPath = path.join(root, 'owcoach_feature_entitlement_contract_v50_13.json');
