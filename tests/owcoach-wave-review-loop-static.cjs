...
['OWC_WAVE_REVIEW_LOOP_DB','owcWaveReviewLoop','owcWaveReviewHtml','owcCompositionWaveReviewLines','1ウェーブ振り返り','Review Loop','Wave review loop static checks passed'].forEach(t=>must(index.includes(t),`missing token ${t}`));
